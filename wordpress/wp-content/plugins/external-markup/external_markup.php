...
function em_extract($content, $start_marker, $end_marker)
{
	...
	$included_part = stristr($content, $start_comment);
	$included_part = substr($included_part, strlen($start_comment));
	$included_part = stristr($included_part, $end_comment, TRUE /* before */);
