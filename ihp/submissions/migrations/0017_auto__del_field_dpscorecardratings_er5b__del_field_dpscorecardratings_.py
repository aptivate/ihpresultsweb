...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'DPScorecardRatings.er5b'
        db.delete_column('submissions_dpscorecardratings', 'er5b')

        # Deleting field 'DPScorecardRatings.er5c'
        db.delete_column('submissions_dpscorecardratings', 'er5c')

        # Deleting field 'DPScorecardRatings.er5a'
        db.delete_column('submissions_dpscorecardratings', 'er5a')

        # Deleting field 'DPScorecardRatings.er4'
        db.delete_column('submissions_dpscorecardratings', 'er4')

        # Deleting field 'DPScorecardRatings.er6'
        db.delete_column('submissions_dpscorecardratings', 'er6')

        # Deleting field 'DPScorecardRatings.er7'
        db.delete_column('submissions_dpscorecardratings', 'er7')

        # Deleting field 'DPScorecardRatings.er1'
        db.delete_column('submissions_dpscorecardratings', 'er1')

        # Deleting field 'DPScorecardRatings.er3'
        db.delete_column('submissions_dpscorecardratings', 'er3')

        # Deleting field 'DPScorecardRatings.er8'
        db.delete_column('submissions_dpscorecardratings', 'er8')

        # Deleting field 'DPScorecardRatings.er2c'
        db.delete_column('submissions_dpscorecardratings', 'er2c')

        # Deleting field 'DPScorecardRatings.er2b'
        db.delete_column('submissions_dpscorecardratings', 'er2b')

        # Deleting field 'DPScorecardRatings.er2a'
        db.delete_column('submissions_dpscorecardratings', 'er2a')


    def backwards(self, orm):
        
        # Adding field 'DPScorecardRatings.er5b'
        db.add_column('submissions_dpscorecardratings', 'er5b', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)

        # Adding field 'DPScorecardRatings.er5c'
        db.add_column('submissions_dpscorecardratings', 'er5c', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)

        # Adding field 'DPScorecardRatings.er5a'
        db.add_column('submissions_dpscorecardratings', 'er5a', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)

        # Adding field 'DPScorecardRatings.er4'
        db.add_column('submissions_dpscorecardratings', 'er4', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)

        # Adding field 'DPScorecardRatings.er6'
        db.add_column('submissions_dpscorecardratings', 'er6', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)

        # Adding field 'DPScorecardRatings.er7'
        db.add_column('submissions_dpscorecardratings', 'er7', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)

        # Adding field 'DPScorecardRatings.er1'
        db.add_column('submissions_dpscorecardratings', 'er1', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)

        # Adding field 'DPScorecardRatings.er3'
        db.add_column('submissions_dpscorecardratings', 'er3', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)

        # Adding field 'DPScorecardRatings.er8'
        db.add_column('submissions_dpscorecardratings', 'er8', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)

        # Adding field 'DPScorecardRatings.er2c'
        db.add_column('submissions_dpscorecardratings', 'er2c', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)

        # Adding field 'DPScorecardRatings.er2b'
        db.add_column('submissions_dpscorecardratings', 'er2b', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)

        # Adding field 'DPScorecardRatings.er2a'
        db.add_column('submissions_dpscorecardratings', 'er2a', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)
