...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        for ratings in orm.CountryScorecardOverride.objects.all():
            for language in orm.Language.objects.all():
                ...
                comments, _ = orm.CountryScorecardOverrideComments.objects.get_or_create(country=c, language=l)
                comments.rf2 = ratings.rf2
                comments.rf3 = ratings.rf3
                comments.dbr2 = ratings.dbr2
                comments.hmis2 = ratings.hmis2
                comments.jar4 = ratings.jar4
                comments.pfm2 = ratings.pfm2
                comments.pr2 = ratings.pr2
                comments.ta2 = ratings.ta2
                comments.pf2 = ratings.pf2
                comments.cd2 = ratings.cd2
