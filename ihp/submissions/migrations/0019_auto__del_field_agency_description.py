...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Agency.description'
        db.delete_column('submissions_agency', 'description')


    def backwards(self, orm):
        
        # Adding field 'Agency.description'
        db.add_column('submissions_agency', 'description', self.gf('django.db.models.fields.TextField')(default='', blank=True), keep_default=False)
