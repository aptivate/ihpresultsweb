...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Agency.display_name'
        db.add_column('submissions_agency', 'display_name', self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Agency.display_name'
        db.delete_column('submissions_agency', 'display_name')
