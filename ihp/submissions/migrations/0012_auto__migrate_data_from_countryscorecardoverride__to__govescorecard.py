...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        for override in orm.CountryScorecardOverride.objects.all():
            c = orm.Country.objects.get(country=override.country.country)
            ratings, _ = orm.GovScorecardRatings.objects.get_or_create(country=c)
            ratings.hmis1 = override.hmis1
            ratings.jar1 = override.jar1
            ratings.hsp1 = override.hsp1
            ratings.hsp2 = override.hsp2
            ratings.hsm1 = override.hsm1
            ratings.hsm4 = override.hsm4
            ratings.save()
