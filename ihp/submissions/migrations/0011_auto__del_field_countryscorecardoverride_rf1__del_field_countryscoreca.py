...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'CountryScorecardOverride.rf1'
        db.delete_column('submissions_countryscorecardoverride', 'rf1')

        # Deleting field 'CountryScorecardOverride.dbr1'
        db.delete_column('submissions_countryscorecardoverride', 'dbr1')

        # Adding field 'GovScorecardRatings.hmis1'
        db.add_column('submissions_govscorecardratings', 'hmis1', self.gf('django.db.models.fields.CharField')(max_length=20, null=True, blank=True), keep_default=False)

        # Adding field 'GovScorecardRatings.jar1'
        db.add_column('submissions_govscorecardratings', 'jar1', self.gf('django.db.models.fields.CharField')(max_length=20, null=True, blank=True), keep_default=False)

        # Adding field 'GovScorecardRatings.hsp1'
        db.add_column('submissions_govscorecardratings', 'hsp1', self.gf('django.db.models.fields.CharField')(max_length=20, null=True, blank=True), keep_default=False)

        # Adding field 'GovScorecardRatings.hsp3'
        db.add_column('submissions_govscorecardratings', 'hsp3', self.gf('django.db.models.fields.CharField')(max_length=20, null=True, blank=True), keep_default=False)

        # Adding field 'GovScorecardRatings.hsm1'
        db.add_column('submissions_govscorecardratings', 'hsm1', self.gf('django.db.models.fields.CharField')(max_length=20, null=True, blank=True), keep_default=False)

        # Adding field 'GovScorecardRatings.hsm4'
        db.add_column('submissions_govscorecardratings', 'hsm4', self.gf('django.db.models.fields.CharField')(max_length=20, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'CountryScorecardOverride.rf1'
        db.add_column('submissions_countryscorecardoverride', 'rf1', self.gf('django.db.models.fields.CharField')(max_length=20, null=True, blank=True), keep_default=False)

        # Adding field 'CountryScorecardOverride.dbr1'
        db.add_column('submissions_countryscorecardoverride', 'dbr1', self.gf('django.db.models.fields.CharField')(max_length=20, null=True, blank=True), keep_default=False)

        # Deleting field 'GovScorecardRatings.hmis1'
        db.delete_column('submissions_govscorecardratings', 'hmis1')

        # Deleting field 'GovScorecardRatings.jar1'
        db.delete_column('submissions_govscorecardratings', 'jar1')

        # Deleting field 'GovScorecardRatings.hsp1'
        db.delete_column('submissions_govscorecardratings', 'hsp1')

        # Deleting field 'GovScorecardRatings.hsp3'
        db.delete_column('submissions_govscorecardratings', 'hsp3')

        # Deleting field 'GovScorecardRatings.hsm1'
        db.delete_column('submissions_govscorecardratings', 'hsm1')

        # Deleting field 'GovScorecardRatings.hsm4'
        db.delete_column('submissions_govscorecardratings', 'hsm4')
    ...
    models = {
        ...
        'submissions.govscorecardratings': {
            ...
            'hsm4': ('django.db.models.fields.CharField', [], {'max_length': '20', 'null': 'True', 'blank': 'True'}),
            'hsp1': ('django.db.models.fields.CharField', [], {'max_length': '20', 'null': 'True', 'blank': 'True'}),
            'hsp3': ('django.db.models.fields.CharField', [], {'max_length': '20', 'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'jar1': ('django.db.models.fields.CharField', [], {'max_length': '20', 'null': 'True', 'blank': 'True'}),
            'r1': ('django.db.models.fields.CharField', [], {'max_length': '20', 'null': 'True', 'blank': 'True'}),
            'r2a': ('django.db.models.fields.CharField', [], {'max_length': '20', 'null': 'True', 'blank': 'True'}),
