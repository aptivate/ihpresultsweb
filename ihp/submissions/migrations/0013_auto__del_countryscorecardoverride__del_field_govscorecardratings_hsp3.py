...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'GovScorecardRatings.hsp2'
        db.add_column('submissions_govscorecardratings', 'hsp2', self.gf('django.db.models.fields.CharField')(max_length=20, null=True, blank=True), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'GovScorecardRatings.hsp2'
        db.delete_column('submissions_govscorecardratings', 'hsp2')
