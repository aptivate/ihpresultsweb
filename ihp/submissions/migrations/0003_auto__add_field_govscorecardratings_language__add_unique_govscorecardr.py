...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'GovScorecardRatings.language'
        db.add_column('submissions_govscorecardratings', 'language', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['submissions.Language']), keep_default=False)
