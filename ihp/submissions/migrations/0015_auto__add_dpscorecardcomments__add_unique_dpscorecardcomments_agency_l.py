...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'DPScorecardComments'
        db.create_table('submissions_dpscorecardcomments', (
        ...
        db.send_create_signal('submissions', ['DPScorecardComments'])

        # Adding unique constraint on 'DPScorecardComments', fields ['agency', 'language']
        db.create_unique('submissions_dpscorecardcomments', ['agency_id', 'language_id'])

    def backwards(self, orm):
        
        # Removing unique constraint on 'DPScorecardComments', fields ['agency', 'language']
        db.delete_unique('submissions_dpscorecardcomments', ['agency_id', 'language_id'])

        # Deleting model 'DPScorecardComments'
        db.delete_table('submissions_dpscorecardcomments')
