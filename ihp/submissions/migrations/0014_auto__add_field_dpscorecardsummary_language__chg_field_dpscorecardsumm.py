...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Removing unique constraint on 'DPScorecardSummary', fields ['agency']
        db.delete_unique('submissions_dpscorecardsummary', ['agency_id'])

        # Adding field 'DPScorecardSummary.language'
        db.add_column('submissions_dpscorecardsummary', 'language', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['submissions.Language']), keep_default=False)

        # Changing field 'DPScorecardSummary.agency'
        db.alter_column('submissions_dpscorecardsummary', 'agency_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['submissions.Agency']))

        # Adding unique constraint on 'DPScorecardSummary', fields ['agency', 'language']
        db.create_unique('submissions_dpscorecardsummary', ['agency_id', 'language_id'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'DPScorecardSummary', fields ['agency', 'language']
        db.delete_unique('submissions_dpscorecardsummary', ['agency_id', 'language_id'])

        # Deleting field 'DPScorecardSummary.language'
        db.delete_column('submissions_dpscorecardsummary', 'language_id')

        # Changing field 'DPScorecardSummary.agency'
        db.alter_column('submissions_dpscorecardsummary', 'agency_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['submissions.Agency'], unique=True))

        # Adding unique constraint on 'DPScorecardSummary', fields ['agency']
        db.create_unique('submissions_dpscorecardsummary', ['agency_id'])
