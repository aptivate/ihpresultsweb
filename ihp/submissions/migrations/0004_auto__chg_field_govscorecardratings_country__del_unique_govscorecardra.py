...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Removing unique constraint on 'GovScorecardRatings', fields ['country']
        db.delete_unique('submissions_govscorecardratings', ['country_id'])

        # Changing field 'GovScorecardRatings.country'
        db.alter_column('submissions_govscorecardratings', 'country_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['submissions.Country']))


    def backwards(self, orm):
        
        # Changing field 'GovScorecardRatings.country'
        db.alter_column('submissions_govscorecardratings', 'country_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['submissions.Country'], unique=True))

        # Adding unique constraint on 'GovScorecardRatings', fields ['country']
        db.create_unique('submissions_govscorecardratings', ['country_id'])
