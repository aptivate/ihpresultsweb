...
this.bar_width).attr({fill:k,"stroke-width":0,stroke:k,"stroke-opacity":0});p.push(m,o);i<0&&m.attr({width:-m.attrs.width-this.bar_width}).translate(i+this.bar_width/2,0)}if(this.options.datalabels){var s=this.options.hover_color||k,q=this.paper.set();m=this.datalabel[l].toString();m=this.paper.text(f+i+this.x_padding_left/2,o.attrs.y-this.options.font_size*1.5,m).attr({"font-size":this.options.font_size,fill:this.options.hover_text_color,opacity:1});var u=this.paper.rect(this.x_padding_left,e,this.graph_width,
this.bar_width).attr({fill:k,"stroke-width":0,stroke:k,opacity:0}),r=m.getBBox();i<0&&m.translate(r.width,0);var t=this.drawRoundRect(m,r,4);r=this.drawNib(m,r,4);q.push(t,r,m).attr({opacity:0});this.checkHoverPos({rect:t,set:q,nib:r});this.globalHoverSet.push(q);this.globalBlockSet.push(u);t.attrs.y<0&&q.translate(0,1-t.attrs.y);u.hover(function(){n?p.animate({fill:s,stroke:s},200):o.animate({fill:s,stroke:s},200);q.animate({opacity:1},200)},function(){n?p.animate({fill:k,stroke:k},200):o.animate({fill:k,
stroke:k},200);q.animate({opacity:0},200)})}e+=this.step}.bind(this))},drawFocusHint:function(){var a=this.x_padding_left+10,b=this.options.height-this.y_padding_bottom-2.5;this.paper.path().attr({stroke:this.options.label_color,"stroke-width":2}).moveTo(a,b).lineTo(a-5,b+5).moveTo(a-5,b).lineTo(a-10,b+5)},drawVerticalLabels:function(){var a=this.step/2,b=this.options.label_rotation?{"text-anchor":"end",rotation:this.options.label_rotation,translation:"0 "+this.options.font_size/2}:{"text-anchor":"end"},
